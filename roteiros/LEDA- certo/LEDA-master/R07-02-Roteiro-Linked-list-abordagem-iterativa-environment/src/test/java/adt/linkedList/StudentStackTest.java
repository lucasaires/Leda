...
public class StudentStackTest {
	...
	private void getImplementations() {
		try {
			stack1 = new StackDoubleLinkedListImpl<Integer>(2);
			stack1.push(new Integer(1));
			stack1.push(new Integer(2));

			stack2 = new StackDoubleLinkedListImpl<Integer>(3);
	...
	public void testNegativeSizes() {
		stack1 = new StackDoubleLinkedListImpl<Integer>(0);
		...
		stack2 = new StackDoubleLinkedListImpl<Integer>(-4);
